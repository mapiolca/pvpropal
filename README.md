# PVPROPAL FOR [DOLIBARR ERP & CRM](https://www.dolibarr.org)
...
Clone the repository in `$dolibarr_main_document_root_alt/pvpropal`

```shell
cd ....../custom
git clone git@github.com:gitlogin/pvpropal.git pvpropal
```
